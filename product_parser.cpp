...
{
    Product* BookParser = new Book(categoryID(),prodName_, price_, qty_,isbn_,author_);
...
{
    Product* ClothingParser = new Clothing(categoryID(),prodName_,price_,qty_,size_,brand_);
...
{
    Product* MovieParser = new Movie(categoryID(), prodName_, price_, qty_,genre_, rating_);
    return MovieParser;
